...
<head>
    ...
    <meta http-equiv="mobile-agent" content="format=wml;url=http://colleges.gaokao.com/sitemap/colleges.gaokao.com.xml"/>
    ...
    <div class="inner po_re" style="z-index: 10;">
        <div class="sec_head_con tp15">
            <a class="logo" href="http://www.gaokao.com" target="_blank">
                <img src="/images/1.gif" alt="高考帮" title="高考帮" width="300"
                     height="60">
            </a>
            <script>
                jQuery(function () {
...
<div class="wrap">
    ...
    <div class="channel_Nav">
        ...
        <ul id="over">
            <li><a href="<%=basePath%>">高校搜索</a></li>
            <li><a href="<%=basePath%>index/zhuanyechaxun/spelist.jsp">专业搜索</a></li>
            <li><a href="<%=basePath%>index/zhuanyefenshuxian/spepoint.jsp">专业分数线</a></li>
        </ul>
    </div>
</div>
<script type="text/javascript">
    ...
    $("#schbtn_h").click(function () {
        var schname = $("#schname_h").val();
        if (schname != '搜索高校' && schname != '') {
            var $form = $("<form action='<%=basePath%>colleges/queryBySchname' method='post'/>")
            var $input1 = $('<input name="schname"/>');
            $input1.val(schname);
            $form.append($input1);
